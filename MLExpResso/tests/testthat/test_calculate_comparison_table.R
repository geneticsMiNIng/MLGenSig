...
test_that("Output", {
  expect_is(calculate_comparison_table(data_e, data_m, cond, cond, test1="nbinom2", test2="ttest"), "data.frame")
  expect_equal(nrow(calculate_comparison_table(data_e, data_m, cond, cond, test1="nbinom2", test2="ttest")), 4)
})
