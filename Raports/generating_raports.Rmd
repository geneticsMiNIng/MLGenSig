...
Function `raport_generate` for generating raports:

```{r, message=FALSE, warning=FALSE, eval=FALSE}
raport_generate(BRCA_mRNAseq_all[,-1], BRCA_methylation_all[,-1], condition.e, condition.m,
