...
```{r, message=FALSE, fig.height=20, fig.width=20}
...
```{r, message=FALSE, fig.height=20, fig.width=19}
visual_volc(condition.e, condition.m, BRCA_methylation_chr17[,-1],BRCA_mRNAseq_chr17[,-1], "BRCA1", list(test.expr,test.expr,test.expr,test.expr), list(test.mety,test.mety))
