...
g <- genereg_vs_met(BRCA_methylation_chr17, condition.m, "BRCA1", observ = TRUE)
#normalization * 10000
...
v.e <- volcano_plot(test.expr, ngen = "BRCA1",ylog=FALSE, title="expression", fold_line = 2, line=0.05)


BRCA_methylation_chr17_gen <- map_to_gene(BRCA_methylation_chr17[,-1])
test.mety <- test_diff(BRCA_methylation_chr17_gen, condition.m, test="ttest")
v.m <- volcano_plot(test.mety,ngen = "BRCA1",ylog=FALSE,title="methylation",line=0.05)
