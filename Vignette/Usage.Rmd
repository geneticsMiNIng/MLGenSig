...
conditionm <- ifelse(BRCA_mRNAseq_chr17$SUBTYPE=="LumA","LumA", "other")
b1 <- boxplot_gene_expr2(BRCA_mRNAseq_chr17,conditionm,"BRCA1")
v <- volcano_plot(test.expr, ngen = "BRCA1", title="expression", fold_line = 2, line=0.05)
condition <- ifelse(BRCA_mRNAseq_chr17[,1]=="LumA","LumA","other")
s <- tableGrob(t(sum_gen(BRCA_mRNAseq_chr17[,-1],condition , "BRCA1")))
