...
#normalization * 10000
BRCA_mRNAseq_chr17_norm <- 10000 * BRCA_mRNAseq_chr17$BRCA1/(max(BRCA_mRNAseq_chr17$BRCA1)-min(BRCA_mRNAseq_chr17$BRCA1)) 
b1 <- boxplot_that(BRCA_mRNAseq_chr17_norm,"BRCA1",condition.e)
...
visual(condition.e, condition.m, BRCA_methylation_chr17[,-1],BRCA_mRNAseq_chr17, "BRCA1", test.expr, test.mety)
