...
#' The function provides use two tests: t-test and negative binomial test for data from gene expression.
#' By default function \code{test_diff} calls the \code{mety_ttest}.
#'
